...
/*
    ...
    * 
    * Q1. Use an array to make a list of 5 of your favorite songs. Print the entire array and its length.
    * Q2. Change the third song on your list to a song that you really dislike. Print the modified array.
    * Q3. Remove a song from the end of your array. Print the modified array.
    * Q4. Add a new song to the end of your array. Print the modified array.
    * Q5. Remove a song from the beginning of your array. Print the modified array.
    * Q6. Add a new song to the beginning of your array. Print the modified array.
    * Q7. Try to access the 10th song on your list. What happens?
*/
// Write your code below this line -->
...
/*
    ...
    * 
    * Q8. Use a for loop to print the sum of each row on a new line.
    * Q9. Use a for loop to calculate the sum of the diagonals.
    * Q10. Do both in a single for loop.
*/
...
[
    ...
    [4, 5, 6],
    [7, 8, 9]
] // Declared the array to use above
// Write your code below this line -->


/**
 * Part 4: Movie Theatre
 * Description: You are nosw going to explore how to represent a movie theatre as an array of arrays. Make an array representation of a theatre with 3 rows and 5 seats per row, 
 * and print the representation of your theatre.
 * 
 * Q11. You are now accepting ticket purchases, and need to put an "X" in the seats that are purchased. 
